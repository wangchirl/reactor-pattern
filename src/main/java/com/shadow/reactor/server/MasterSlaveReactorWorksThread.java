 ...
 * work 线程负责处理业务逻辑
 */
public class MasterSlaveReactorWorksThread {
...
//        new MainReactor(8088); // 无从 reactor 线程
        new MainReactor(8088).setSubReactor(new SubReactor()); // 有从 reactor 线程
    }
    ...
    static class MainReactor extends AbstractReactor {
        ...
        public void setSubReactor(AbstractReactor reactor) {
            super.subReactor = reactor;
        }
    ...
    static class SubReactor extends AbstractReactor {
        ...
        SubReactor() {
            try {
                ...
                super.thread = new Thread(this::run, "sub-reactor-thread");
                super.start();
            } catch (Exception e) {
                e.printStackTrace();
            }
